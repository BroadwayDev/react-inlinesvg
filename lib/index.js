...
var InlineSVG = /** @class */ (function (_super) {
    ...
    InlineSVG.prototype.updateSVGAttributes = function (node) {
        ...
        var replaceableAttributes = ['data-id', 'data["id"]', 'href', 'xlink:href', 'xlink:role', 'xlink:arcrole'];
    ...
    InlineSVG.prototype.render = function () {
        ...
        var _b = this.props, baseURL = _b.baseURL, cacheRequests = _b.cacheRequests, _c = _b.children, children = _c === void 0 ? null : _c, description = _b.description, innerRef = _b.innerRef, _d = _b.loader, loader = _d === void 0 ? null : _d, onError = _b.onError, onLoad = _b.onLoad, preProcessor = _b.preProcessor, src = _b.src, title = _b.title, uniqueHash = _b.uniqueHash, uniquifyIDs = _b.uniquifyIDs, wrapper = _b.wrapper, rest = __rest(_b, ["baseURL", "cacheRequests", "children", "description", "innerRef", "loader", "onError", "onLoad", "preProcessor", "src", "title", "uniqueHash", "uniquifyIDs", "wrapper"]);
        if (element) {
            var node = React.cloneElement(element, __assign({ ref: innerRef }, rest));
            if (wrapper()) {
                var everything = React.cloneElement(wrapper(), {}, node);
                return everything;
            }
        }
